  ...
  return (
    ...
    >
      {pending && quickAdd ? (
        ...
        <span className="flex h-full w-full items-center justify-center">
          <Check className="h-3.5 w-3.5 animate-in zoom-in-95 text-slate-950 sm:h-4 sm:w-4" />
        </span>
      ) : iconOnly && quickAdd ? (
        <span
          className={cn(
            "relative flex h-full w-full items-center justify-center text-slate-950 transition-transform duration-300 ease-out",
