        ...
        <div className="ml-auto flex shrink-0 items-center gap-2 sm:gap-3">
          ...
          {session?.user ? (
            <button
              ...
              className="inline-flex min-w-0 max-w-36 items-center gap-2 rounded-full border border-white/10 px-3 py-2 text-sm font-medium text-slate-200 transition hover:bg-white/10 sm:max-w-none sm:px-4"
            >
