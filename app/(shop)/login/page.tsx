  ...
  return (
    <div className="mx-auto grid w-full max-w-7xl gap-10 px-6 py-16 pb-24 lg:grid-cols-[1fr_420px] lg:items-center">
      <section className="rounded-[2.5rem] bg-slate-950 p-10 text-white shadow-2xl shadow-slate-900/20">
        <BrandLogo />
        <p className="mt-8 text-sm font-semibold uppercase tracking-[0.28em] text-amber-300">Account access</p>
        <h1 className="mt-4 font-display text-5xl font-semibold tracking-tight text-balance">Login for pickup checkout, order history, and admin access.</h1>
